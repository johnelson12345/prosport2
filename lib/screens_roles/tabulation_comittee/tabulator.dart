...
class TabulatorScreen extends StatefulWidget {
  const TabulatorScreen({super.key});

  @override
  State<TabulatorScreen> createState() => _TabulatorScreenState();
}

class _TabulatorScreenState extends State<TabulatorScreen> {
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              'Manage tournament tabulation and scoring efficiently',
              style: TextStyle(
                fontSize: 16,
                color: Colors.black,
              ),
            ...
            _buildActionCard(
              ...
              () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => const ResultsVerification(),
                  ),
                );
              },
            ),
