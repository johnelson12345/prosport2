...
class ViewerMain extends StatefulWidget {
  const ViewerMain({super.key});

  @override
  State<ViewerMain> createState() => _ViewerMainState();
}

class _ViewerMainState extends State<ViewerMain>
    with SingleTickerProviderStateMixin {
  String _selectedScreen = 'Announcements';
